...
- 上游：用户 prompt
- 下游：xdd-design（spec + architecture + wire）只消费 design.md + intent.md，不读发散笔记

## 完成后

回报 xdd-flow：design.md 路径 + 自检结果 + **等用户审 design.md 通过**才进 xdd-design。
